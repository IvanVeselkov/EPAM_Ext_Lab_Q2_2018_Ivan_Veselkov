...
ALTER TABLE [dbo].[Answers]
    ADD FOREIGN KEY ([QuestID]) REFERENCES [dbo].[Questions] ([ID]);
...
ALTER TABLE [dbo].[Questions]
    ADD FOREIGN KEY ([TestID]) REFERENCES [dbo].[Tests] ([ID]);
...
ALTER TABLE [dbo].[Users]
    ADD FOREIGN KEY ([UserRole]) REFERENCES [dbo].[Roles] ([ID]);


GO
PRINT N'Выполняется создание [dbo].[GetAllUsers]...';
